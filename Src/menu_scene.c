...
static void update(void) {
 ...
 /*   if (keyState[ALLEGRO_KEY_ENTER]) {
    ...
    */
    ...
    if (mouseState.buttons && playButton.hovered == true) {
        change_scene(create_loading_scene());
    }
...
static void draw(void) {
    ...
    al_draw_text(
        ...
        SCREEN_W / 2,
        500 + 28 + playButton.hovered * 11, // Gunakan kondisi hover dari playButton
        ALLEGRO_ALIGN_CENTER,
        "PLAY"
    );
    al_draw_text(
        ...
        SCREEN_W / 2,
        500 + 31 + playButton.hovered * 11, // Gunakan kondisi hover dari playButton
        ALLEGRO_ALIGN_CENTER,
        "PLAY"
    );
    // --------------------------------------------------------
